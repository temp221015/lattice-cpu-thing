	...
	begin
		if rising_edge(clk) then
			if pc1 = reg_exp_pc then
				...
				if instr1(31) = '1' then
					my_write("(" & my_strnow & ")         Decoder: Branching from pc=" & my_slv2str(pc1) & " to pc="  & my_slv2str(instr1(15 downto 0)) & LF);
				...
				my_write("(" & my_strnow & ")         Decoder: Mispredict (exp_pc=" & my_slv2str(reg_exp_pc) & " pc1="   & my_slv2str(pc1) & ")" & LF);
				reg_miss <= '1';
